...
class DoughnutChart extends Component {
    ...
    // //TODO: Make it only call initiateChart when the submit range button is pressed
    // componentDidMount() {
    //     const { index } = this.props;
    //     console.log(index)
    //     initiateChart(index);
    ...
    componentDidUpdate() {
        ...
        else if (didDraw == false && this.props.index != 0) {
            canContinue = true;
        }
    ...
    render() {
        ...
        return (
            <g height={1000} width={1000} className={'flow-data-chart doughnut-chart' + this.props.index} transform="translate(150, 150)"></g>
        );
...
function initiateChart(index) {
    ...
    if (dataList.length > 0) {
        ...
        makeDoughnutChart(data, index) //TODO: Change 0 to index
    }
}

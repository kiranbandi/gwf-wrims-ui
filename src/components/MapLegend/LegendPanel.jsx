                    ...
                    <div className='filter-div'>
                        <svg width="600" height="60">
                            <g key={'marker-green'} className='river-marker'
                                transform={"translate(60, 5) scale(0.08)"}>
                                <circle
                                    cx='150' cy='150' r='200'
                                    className={'type-agri'}>
                                </circle>
                            ...
                            <g key={'marker-green-image'} className='river-marker'
                                transform={"translate(60, 7) scale(0.048)"}>
                            ...
                            <text x="40" y="52.5" className="legend-label">IRRIGATION</text>

                            <g key={'marker-blue'} className='river-marker'
                                transform={"translate(180, 5) scale(0.08)"}>
                                <circle
                                    cx='150' cy='150' r='200'
                            ...
                            <g key={'marker-blue-image'} className='river-marker'
                                transform={"translate(180, 5) scale(0.055)"}>
                            ...
                            <text x="145" y="52.5" className="legend-label">NON-IRRIGATION</text>

                            <g key={'marker-gray'} className='river-marker'
                                transform={"translate(300, 5) scale(0.08)"}>
                                <circle
                                    cx='150' cy='150' r='200'
                            ...
                            <g key={'reservoir-cyan-image'} className='river-marker'
                             ...
                             <text x="400" y="52.5" className="legend-label">RESERVOIR</text>

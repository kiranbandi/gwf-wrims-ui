                    ...
                    <div className='filter-div'>
                        <svg width="600" height="60">
                            <g key={'marker-green'} className='river-marker'
                                transform={"translate(65, 5) scale(0.08)"}>
                                <circle
                                    cx='150' cy='150' r='200'
                                    className={'type-agri'}>
                                </circle>
                            ...
                            <g key={'marker-green-image'} className='river-marker'
                                transform={"translate(65, 7) scale(0.048)"}>
                            ...
                            <text x="35" y="52.5" className="legend-label">IRRIGATION</text>

                            <g key={'marker-blue'} className='river-marker'
                                transform={"translate(215, 5) scale(0.08)"}>
                                <circle
                                    cx='150' cy='150' r='200'
                            ...
                            <g key={'marker-blue-image'} className='river-marker'
                                transform={"translate(215, 5) scale(0.055)"}>
                            ...
                            <text x="165" y="52.5" className="legend-label">NON-IRRIGATION</text>

                            <g key={'marker-gray'} className='river-marker'
                                transform={"translate(365, 5) scale(0.08)"}>
                                <circle
                                    cx='150' cy='150' r='200'
                                    className={'type-inflow'}>
                                </circle>
                            </g>
                            <g key={'marker-gray-image'} className='river-marker'
                                transform={"translate(365, 5) scale(0.08)"}>
                            ...
                            <g key={'reservoir-cyan-image'} className='river-marker'
                             ...
                             <text x="485" y="52.5" className="legend-label">RESERVOIR</text>
                </svg>
                    </div>
                        ...
                        <svg className='flow-data-chart' width="600" height="60">
                            <g className='lines-container'>
                                ...
                                <path className='flow-spark-line'
                                    ...
                                    className={'river forward-flow'}
                                />
                                <text x="485" y="52.5" className="legend-label">DIVERSION</text>
                            </g>

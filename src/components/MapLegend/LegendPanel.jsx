                    ...
                    <div className='filter-div'>
                        <svg width="550" height="60">
                            ...
                            <g key={'marker-blue-image'} className='river-marker'
                                transform={"translate(165, 5) scale(0.055)"}>
                            ...
                            <text x="145" y="52.5" className="legend-label">DEMAND</text>
                            <g key={'marker-green'} className='river-marker'
                                transform={"translate(315, 5) scale(0.08)"}>
                                <circle
                                    cx='150' cy='150' r='200'
                                    className={'type-agri'}>
                                </circle>
                            ...
                            <g key={'marker-green-image'} className='river-marker'
                                transform={"translate(315, 5) scale(0.048)"}>
                            ...
                            <g key={'reservoir-cyan-image'} className='river-marker'
                             ...
                             <text x="445" y="52.5" className="legend-label">RESERVOIR</text>
                </svg>
                    </div>

                    <div className='filter-div'>
                        <svg className='flow-data-chart' width="550" height="60">
                            <g className='lines-container'>
                                ...
                                />
                                <text x="5" y="52.5" className="legend-label">INFLOW</text>
                                <path className='flow-spark-line'
                                    ...
                                    className={'river forward-flow'}
                                />
                                <text x="155" y="52.5" className="legend-label">DEMAND</text>
                                <path className='flow-spark-line'
                                    ...
                                    className={'river forward-flow'}
                                />
                                <text x="305" y="52.5" className="legend-label">IRRIGATION</text>
                                <path className='flow-spark-line'
                                    ...
                                    className={'river forward-flow'}
                                />
                                <text x="455" y="52.5" className="legend-label">DIVERSION</text>
                            </g>

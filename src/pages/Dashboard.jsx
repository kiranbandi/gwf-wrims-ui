...
import { setFlowData, setMode, setUser, setUserData, setTrackedUser, setInfoModalState } from '../redux/actions/actions';
...
class DashboardRoot extends Component {
    ...
    render() {
        ...
        const {infoModalState, actions, mode, datastore, username, userData, trackedUser } = this.props;
...
function mapDispatchToProps(dispatch) {
    return {
        actions: bindActionCreators({ setFlowData, setMode, setUser, setUserData, setTrackedUser, setInfoModalState }, dispatch)
    };
}
